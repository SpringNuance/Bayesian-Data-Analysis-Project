...
stan_data <- list(
  ...
  N_list = N_list,
  M_list = M_list,
  js_len_list = js_len_list,
  js_obf_len_list = js_obf_len_list,
  https_list = https_list,
  whois_list = whois_list,
  js_len_pred_list = js_len_test_list,
  js_obf_len_pred_list = js_obf_len_test_list,
  https_pred_list = https_test_list,
  whois_pred_list = whois_test_list,
  label_list = label_list
)
  hierarchical_sampling <- model_hierarchical$sample(data = stan_data, chains=4, iter_warmup = 2000, iter_sampling = 2000, show_messages=FALSE, refresh=0)
```
